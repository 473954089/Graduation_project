...
Page({
  ...
  submit:function(e){
    ...
    var param = {
      // anonymous: that.data.state,
      contentTittle: e.detail.value.tittle,
      contentText: e.detail.value.content,
      // picker_index: e.detail.value.sort,
      // contentPic: contentPic,
      // voice: that.data.voice_src,
      // avatar : that.data.userInfo.avatar,
      // nickName: that.data.userInfo.nickname,
      userId : that.data.userInfo.uuid,
    }
    dao.submitQuestion(param,function(){
      wx.showLoading({
        title: '发布中。。。',
      })
